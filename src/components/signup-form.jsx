    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        <div className="flex flex-col items-start gap-1">
          <h1 className="text-2xl font-bold tracking-tighter">Reach your potential, connect with top talent for the small wins</h1>
          <p className="text-muted-foreground text-sm text-balance">
            Sign up to become one of our stars.
          </p>
        </div>
        <Field>
